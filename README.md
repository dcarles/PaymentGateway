...
* **Web API Projects** : ASP.NET Core 6
...
```
API	  : http://localhost:55000/api/payments
MS SQL	  : localhost,1400
Simulator : http://localhost:5007/api/payments
```

```
NOTE! IF FOR SOME REASON THE API THROUGH DOCKER LOOKS UNRESPONSIVE (OR YOU JUST SIMPLY WANT TO DEBUG OR RUN 
FROM VS), RUN THE API VIA VISUAL STUDIO AND THEN USE THE FOLLOWING URL INSTEAD:
API	  : http://localhost:55949/api/payments or https://localhost:44326/api/payments
```
